...
var customField = {
    ...
    loadTemplates: function (select) {
        ...
        $.ajax({
            url: '/admin/custom_fields/ajaxLoadTemplates/',
    ...
    addField: function (groupId) {
        ...
        var _this = this;
        $.ajax({
            url: '/admin/custom_fields/ajaxLoadNewFieldTemplate/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
    ...
    updateFieldsGroup: function (button) {
        ...
        var _this = this;
        $.ajax({
            url: '/admin/custom_fields/ajaxUpdateFields/',
            type: this.ajaxMethod,
            data: formData,
            beforeSend: function(){
    ...
    addGroup: function (button) {
        ...
        $.ajax({
            url: '/admin/custom_fields/ajaxAddGroup/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
